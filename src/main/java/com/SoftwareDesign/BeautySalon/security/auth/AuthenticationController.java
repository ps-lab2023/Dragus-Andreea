...
public class AuthenticationController {
    ...
    public ResponseEntity<AuthenticationResponse> authenticate(@RequestBody AuthenticationRequest request) throws UserNotFoundException, DataBaseFailException, InvalidUserException, ClientNotFoundException, InvalidClientException, InvalidEmployeeException, EmployeeNotFoundException {
