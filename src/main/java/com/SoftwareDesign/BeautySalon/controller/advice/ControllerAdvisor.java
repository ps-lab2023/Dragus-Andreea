...
import com.SoftwareDesign.BeautySalon.model.validation.exception.*;
...
public class ControllerAdvisor extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(InvalidBeautyServiceException.class)
    public ResponseEntity<Map<String, Object>>handleInvalidBeautyService(InvalidBeautyServiceException exc, WebRequest req) {
        Map<String, Object> body = new LinkedHashMap<>();
        body.put("timestamp", LocalDateTime.now());
        body.put("message", exc.getMessage());
